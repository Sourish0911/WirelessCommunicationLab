...
for i = 1:length(snr_db)
    ...
    for j = 1:N/2
        ...
        w1 = h_releigh_rx1(j)*conj(h_releigh_rx1(j)) / (h_releigh_rx1(j)*conj(h_releigh_rx1(j)) + h_releigh_rx2(j)*conj(h_releigh_rx2(j))+h_releigh_rx3(j)*conj(h_releigh_rx3(j)));
        w2 = h_releigh_rx2(j)*conj(h_releigh_rx2(j)) / (h_releigh_rx1(j)*conj(h_releigh_rx1(j)) + h_releigh_rx2(j)*conj(h_releigh_rx2(j))+h_releigh_rx3(j)*conj(h_releigh_rx3(j)));
        w3 = h_releigh_rx3(j)*conj(h_releigh_rx3(j)) / (h_releigh_rx1(j)*conj(h_releigh_rx1(j)) + h_releigh_rx2(j)*conj(h_releigh_rx2(j))+h_releigh_rx3(j)*conj(h_releigh_rx3(j)));
        
        qpsk_symbols_combined(j) = w1*qpsk_symbols_rx1(j)+w2*qpsk_symbols_rx2(j)+w3*qpsk_symbols_rx3(j);
    end
